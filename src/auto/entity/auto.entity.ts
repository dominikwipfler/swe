 ...
 */
export type AutoArt = 'EPUB' | 'HARDCOVER' | 'PAPERBACK';
 ...
 * Im Beispiel ist das JSON-Array in src\auto\entity\entities.ts und
 * TypeOrmModule.forFeature(...) wird in src\auto\auto.module.ts aufgerufen.
 */
